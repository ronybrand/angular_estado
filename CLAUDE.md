...
Front-end Angular do [Projeto Estado](https://github.com/ronybrand/estado) — projeto de portfólio com foco em vagas de **backend**; o frontend existe para demonstrar o projeto de ponta a ponta, não para exibir profundidade em frontend. Evite investimento pesado em polish visual (animações, design system elaborado) além do que já existe — prefira mudanças que leiam bem para um avaliador backend: funcional, limpo, razoavelmente polido.
